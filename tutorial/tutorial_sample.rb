...
Type "cmds" to get a list of the commands that irb_tioga has added.
You should see something like the following:
    ...
    save_list 'filename'          sl          saves list of figures to the named file
              'filename' defaults to 'names.txt'
    open_list 'filename'          ol          calls save_list and then opens the file
              'filename' defaults to 'names.txt'
    ...
    reload_and_review             rr          does reload followed by review
    ...
    eval_function string          ef          call the current file's eval function
